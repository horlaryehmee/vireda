        ...
        <>
            ...
            <main className="page-shell web-development-page data-analytics-page">
                ...
                <ExploreMetricsSection title={<>Facts Over <span>Assumptions</span></>}>
                    <article className="stats-bento-primary"><SatisfactionScore value={98} /><div className="stats-bento-primary-meta"><span><span className="stats-bento-meta-value"><MetricCounter value={5} /></span> Data Sources Connected on Average</span><span className="stats-bento-meta-item-time"><span className="stats-bento-meta-value"><MetricCounter value={3} suffix=" hrs/week" /></span> Average Time Saved on Manual Reporting</span></div></article>
